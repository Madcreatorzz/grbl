...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 656.730
  #define DEFAULT_Y_STEPS_PER_MM 646.460
  #define DEFAULT_Z_STEPS_PER_MM 511.240
  #define DEFAULT_X_MAX_RATE 1500.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 1500.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 500.0 // mm/min
  #define DEFAULT_X_ACCELERATION 70 // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION 50 // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION 100 // 10*60*60 mm/min^2 = 10 mm/sec^2
  ...
  #define DEFAULT_STATUS_REPORT_MASK 19 // MPos enabled
